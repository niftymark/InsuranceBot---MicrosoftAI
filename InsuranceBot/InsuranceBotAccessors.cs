...
namespace InsuranceBot
{
    ...
    ///  - See <see cref="InsuranceIBot"/> constructor for how that is injected.
    ///  - See the Startup.cs file for more details on creating the Singleton that gets
    ///    injected into the constructor.
    /// </summary>
    public class InsuranceBotAccessors
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RennovationsBotAccessors"/> class.
        ...
        public InsuranceBotAccessors(ConversationState conversationState, UserState userState)
        {
        ...
        /// <summary>
        /// Gets or sets the <see cref="IStatePropertyAccessor{T}"/> for InsuranceState.
        /// </summary>
        /// <value>
        /// The accessor stores user data.
        /// </value>
        public IStatePropertyAccessor<InsuranceState> GetInsuranceState { get; set; }
